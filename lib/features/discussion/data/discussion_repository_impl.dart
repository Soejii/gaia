...
class DiscussionRepositoryImpl implements DiscussionRepository {
  ...
  @override
  Future<Result<List<DiscussionEntity>>> getListDiscussion(String type, {int? idSubject}) => guard(
        () async {
          final models = await _dataSource.getListDiscussion(type, idSubject: idSubject);
          return models
              .map(
