...
abstract class $ProfileEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int userId, String name, String className, String imgUrl});
}
...
class _$ProfileEntityImpl implements _ProfileEntity {
  ...
  @override
  String toString() {
    return 'ProfileEntity(userId: $userId, name: $name, className: $className, imgUrl: $imgUrl)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, userId, name, className, imgUrl);
...
abstract class _ProfileEntity implements ProfileEntity {
  const factory _ProfileEntity(
      ...
      required final String imgUrl}) = _$ProfileEntityImpl;
